...
#define PWM_CONTROL_PORT_0  GPIOA
#define PWM_CONTROL_PIN_0   GPIO_Pin_2
#define PWM_CONTROL_PORT_1  GPIOF
#define PWM_CONTROL_PIN_1   GPIO_Pin_9
#define PWM_CONTROL_PORT_2  GPIOF
#define PWM_CONTROL_PIN_2   GPIO_Pin_3
#define PWM_CONTROL_PORT_3  GPIOE
#define PWM_CONTROL_PIN_3   GPIO_Pin_5
#define PWM_CONTROL_PORT_4  GPIOB
#define PWM_CONTROL_PIN_4   GPIO_Pin_3
#define PWM_CONTROL_PORT_5  GPIOA
#define PWM_CONTROL_PIN_5   GPIO_Pin_3
#define PWM_CONTROL_PORT_6  GPIOF
#define PWM_CONTROL_PIN_6   GPIO_Pin_8
#define PWM_CONTROL_PORT_7  GPIOF
#define PWM_CONTROL_PIN_7   GPIO_Pin_2
#define PWM_CONTROL_PORT_8  GPIOE
#define PWM_CONTROL_PIN_8   GPIO_Pin_3
#define PWM_CONTROL_PORT_9  GPIOG
#define PWM_CONTROL_PIN_9   GPIO_Pin_15
