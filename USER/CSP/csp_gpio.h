...
#define WATER_COOL_PUMP_PORT_0  GPIOF
#define WATER_COOL_PUMP_PIN_0   GPIO_Pin_13
#define WATER_COOL_PUMP_PORT_1  GPIOF
#define WATER_COOL_PUMP_PIN_1   GPIO_Pin_14
#define WATER_COOL_PUMP_PORT_2  GPIOF
#define WATER_COOL_PUMP_PIN_2   GPIO_Pin_15    
#define WATER_COOL_PUMP_PORT_3  GPIOG
#define WATER_COOL_PUMP_PIN_3   GPIO_Pin_0
#define WATER_COOL_PUMP_PORT_4  GPIOG
#define WATER_COOL_PUMP_PIN_4   GPIO_Pin_1

#define WATER_COOL_VAVLE_PORT_0 GPIOE
#define WATER_COOL_VAVLE_PIN_0  GPIO_Pin_2
#define WATER_COOL_VAVLE_PORT_1 GPIOE
#define WATER_COOL_VAVLE_PIN_1  GPIO_Pin_3
#define WATER_COOL_VAVLE_PORT_2 GPIOE
#define WATER_COOL_VAVLE_PIN_2  GPIO_Pin_4
#define WATER_COOL_VAVLE_PORT_3 GPIOE
#define WATER_COOL_VAVLE_PIN_3  GPIO_Pin_5
...
#define WATER_COOL_LIQUID_FEEDBACK_PORT_0   GPIOG
#define WATER_COOL_LIQUID_FEEDBACK_PIN_0    GPIO_Pin_9
#define WATER_COOL_LIQUID_FEEDBACK_PORT_1   GPIOG
#define WATER_COOL_LIQUID_FEEDBACK_PIN_1    GPIO_Pin_10
#define WATER_COOL_LIQUID_FEEDBACK_PORT_2   GPIOG
#define WATER_COOL_LIQUID_FEEDBACK_PIN_2    GPIO_Pin_11
#define WATER_COOL_LIQUID_FEEDBACK_PORT_3   GPIOG
#define WATER_COOL_LIQUID_FEEDBACK_PIN_3    GPIO_Pin_12
#define WATER_COOL_LIQUID_FEEDBACK_PORT_4   GPIOG
...
#define HUMIDITY_CONTROL_PORT_0 GPIOG
#define HUMIDITY_CONTROL_PIN_0  GPIO_Pin_2
#define HUMIDITY_CONTROL_PORT_1 GPIOG
...
#define MOTOR_LIMIT_PIN_0   GPIO_Pin_10
#define MOTOR_LIMIT_PORT_1  GPIOC
#define MOTOR_LIMIT_PIN_1   GPIO_Pin_11
#define MOTOR_LIMIT_PORT_2  GPIOC
#define MOTOR_LIMIT_PIN_2   GPIO_Pin_12
#define MOTOR_LIMIT_PORT_3  GPIOD
#define MOTOR_LIMIT_PIN_3   GPIO_Pin_0
#define MOTOR_LIMIT_PORT_4  GPIOD
#define MOTOR_LIMIT_PIN_4   GPIO_Pin_1
#define MOTOR_LIMIT_PORT_5  GPIOD
#define MOTOR_LIMIT_PIN_5   GPIO_Pin_2
#define MOTOR_LIMIT_PORT_6  GPIOD
#define MOTOR_LIMIT_PIN_6   GPIO_Pin_3
#define MOTOR_LIMIT_PORT_7  GPIOD
#define MOTOR_LIMIT_PIN_7   GPIO_Pin_4
#define MOTOR_LIMIT_PORT_8  GPIOD
#define MOTOR_LIMIT_PIN_8   GPIO_Pin_5
...
#define KEY_IN_PIN_0    GPIO_Pin_9
#define KEY_IN_PORT_1   GPIOD
#define KEY_IN_PIN_1    GPIO_Pin_10
#define KEY_IN_PORT_2   GPIOD
#define KEY_IN_PIN_2    GPIO_Pin_11
#define KEY_IN_PORT_3   GPIOD
#define KEY_IN_PIN_3    GPIO_Pin_12
#define KEY_IN_PORT_4   GPIOD
#define KEY_IN_PIN_4    GPIO_Pin_13
...
#define FAN_SYSTEM_CONTROL_PORT_0   GPIOG
#define FAN_SYSTEM_CONTROL_PIN_0    GPIO_Pin_4
#define FAN_SYSTEM_CONTROL_PORT_1   GPIOG
#define FAN_SYSTEM_CONTROL_PIN_1    GPIO_Pin_5
#define FAN_SYSTEM_CONTROL_PORT_2   GPIOG
#define FAN_SYSTEM_CONTROL_PIN_2    GPIO_Pin_6
#define FAN_SYSTEM_CONTROL_PORT_3   GPIOG
#define FAN_SYSTEM_CONTROL_PIN_3    GPIO_Pin_7
#define FAN_SYSTEM_CONTROL_PORT_4   GPIOG
#define FAN_SYSTEM_CONTROL_PIN_4    GPIO_Pin_8
