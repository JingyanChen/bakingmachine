 ...
 * 1000         2S时间
 *
 * 综合来看，选择4S的开机时间是比较OK的，所以先找到4S的匀速运动比例
 * 在650-700之间二分查找
 * 675  3.9S左右 可以略快，所以选择700作为常规加速值，也就是峰值
 * 
 * 考虑在600-700之间加减速
 * 
 */
